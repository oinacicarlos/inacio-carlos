...
export default function AbrirCnpjFlow() {
  const [step, setStep] = useState<Step>("choose")

  return (
    <ToolShell mainClassName="abrir-cnpj-page">
      <section className="abrir-cnpj-section" aria-labelledby="abrir-cnpj-title">
...
function ChooseRegime({ onPickMei, onPickPresumido }: { onPickMei: () => void; onPickPresumido: () => void }) {
  return (
    <>
      <div className="abrir-cnpj-hero">
        <p className="abrir-cnpj-eyebrow">Abrir CNPJ</p>
        <h1 id="abrir-cnpj-title">Qual enquadramento combina com o seu negócio?</h1>
        <p className="abrir-cnpj-hero-sub">
      ...
      <div className="abrir-cnpj-cards">
        <article className="abrir-cnpj-card">
          <span className="abrir-cnpj-card-icon" aria-hidden="true">
            <Award size={26} strokeWidth={1.8} />
          </span>
          <h2>MEI</h2>
          <span className="abrir-cnpj-card-badge abrir-cnpj-card-badge--free">Grátis</span>
          ...
          <button type="button" className="abrir-cnpj-card-cta" onClick={onPickMei}>
            Quero abrir meu MEI
          </button>
        </article>

        <article className="abrir-cnpj-card is-featured">
          <span className="abrir-cnpj-card-badge-top">Mais escolhido</span>
          <span className="abrir-cnpj-card-icon" aria-hidden="true">
            <Building2 size={26} strokeWidth={1.8} />
          </span>
          <h2>Simples Nacional</h2>
          <span className="abrir-cnpj-card-badge">R$ 1.460,50</span>
          ...
          <ul>
            ...
            <li>Protocolo na Junta Comercial incluso</li>
          </ul>
          <StripeProductButton product="abertura_empresa" className="abrir-cnpj-card-cta is-primary">
            Abrir minha empresa
          </StripeProductButton>
        </article>
        ...
        <article className="abrir-cnpj-card">
          ...
          <span className="abrir-cnpj-card-badge abrir-cnpj-card-badge--contact">Fale com a equipe</span>
          ...
          <button type="button" className="abrir-cnpj-card-cta" onClick={onPickPresumido}>
            Falar com a equipe
          </button>
        </article>
      </div>
...
function MeiFlow({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="abrir-cnpj-panel">
      <button type="button" className="abrir-cnpj-back" onClick={onBack}>
        ← Voltar
      </button>

      <h2>Abertura de MEI</h2>
      <p className="abrir-cnpj-panel-sub">Cadastro gratuito. Depois de continuar, você preenche a triagem no seu hub e envia:</p>

      <ul className="abrir-cnpj-doc-list">
        <li>
      ...
      <div className="abrir-cnpj-warning">
        ...
        <p>
          ...
          conseguirmos dar entrada de forma automática no seu MEI — você pode reativar assim que o processo terminar.
        </p>
      </div>

      {error && <p className="abrir-cnpj-error">{error}</p>}

      <button type="button" className="abrir-cnpj-card-cta is-primary" onClick={handleContinue} disabled={loading}>
...
function PresumidoRealForm({ onBack, onSuccess }: { onBack: () => void; onSuccess: () => void }) {
  ...
  return (
    <div className="abrir-cnpj-panel">
      ...
      <h2>Lucro Presumido ou Real</h2>
      <p className="abrir-cnpj-panel-sub">
        Esse enquadramento exige uma análise específica do seu caso. Deixe seus dados que nossa equipe entra em contato.
      </p>

      <form className="abrir-cnpj-form" onSubmit={handleSubmit}>
        <label className="abrir-cnpj-field">
          <span>Nome</span>
        ...
        <button type="submit" className="abrir-cnpj-card-cta is-primary" disabled={loading}>
...
function PresumidoRealSuccess() {
  return (
    <div className="abrir-cnpj-panel">
      ...
      <a href="/" className="abrir-cnpj-card-cta is-primary">
