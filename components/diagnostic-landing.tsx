...
function buildDiagnostic(answers: Record<string, string>): DiagnosticResult {
  ...
  const createDiagnostic = (result: DiagnosticResult) => result
  ...
  if ((mainProblem === 'Muitos leads e poucas vendas') && hasTeam) {
    return createDiagnostic({
      ...
      resumo: `Sua empresa já gera oportunidades${investsMarketing || unhappyMarketing ? ' e investe em marketing' : ''}, mas parte desses contatos não vira venda. Com ${salesTeam} vendedores e um processo ${partialProcess ? 'ainda parcial' : 'pouco definido'}, o problema mais provável não está apenas em atrair pessoas, e sim em conduzir melhor cada lead até a decisão.`,
      gargalo: 'Atendimento, follow-up e fechamento sem padrão claro. Quando cada vendedor conduz a conversa de um jeito, a conversão fica instável.',
      risco: 'Continuar aumentando leads sem ajustar o processo pode elevar o custo de aquisição e criar a sensação de que o marketing não funciona, quando o vazamento está na etapa comercial.',
      ...
      checklist: [
        'Definir etapas claras para primeiro contato, qualificação e fechamento.',
        'Criar um roteiro simples de atendimento para o time.',
        'Acompanhar quantos leads chegam, quantos respondem e quantos fecham.',
      ],
    })
  }
  ...
  if (mainProblem === 'Muitos seguidores que não compram' && fromInstagram) {
    return createDiagnostic({
      ...
      resumo: `O Instagram já gera atenção, mas atenção sozinha não sustenta crescimento. ${noProcess ? 'Sem um processo de vendas definido' : 'Com processo ainda incompleto'}, os seguidores podem consumir conteúdo, curtir e acompanhar, mas não encontram um caminho claro para comprar.`,
      gargalo: 'A comunicação provavelmente atrai interesse, mas a oferta, o direcionamento para compra e o atendimento ainda não estão conectados em um funil simples.',
      risco: 'A empresa pode continuar crescendo em seguidores sem aumentar faturamento, acumulando audiência que não entende claramente o que comprar, por que comprar e como avançar.',
      ...
      checklist: [
        'Deixar claro qual problema sua solução resolve.',
        'Criar chamadas diretas para conversa, orçamento ou compra.',
        'Organizar o atendimento para responder rápido e conduzir o interessado.',
      ],
    })
  }
  ...
  if (unhappyMarketing && mainProblem === 'Muitos leads e poucas vendas') {
    return createDiagnostic({
      ...
      resumo: 'Você já investe em marketing, mas o retorno ainda não acompanha o esforço. Esse costuma ser um dos cenários mais caros, porque existe investimento ativo, geração de demanda e expectativa de venda, mas algo quebra entre o clique, o contato e o fechamento.',
      gargalo: 'Falta clareza sobre onde o funil perde dinheiro: na campanha, na qualidade do lead, no atendimento, no tempo de resposta, na proposta ou no fechamento.',
      risco: 'Aumentar verba sem diagnosticar o gargalo pode apenas acelerar o desperdício e reforçar a percepção de que marketing digital não dá resultado.',
      ...
      checklist: [
        'Separar leads por origem e medir conversão de cada canal.',
        'Revisar tempo de resposta e qualidade do primeiro contato.',
        'Comparar promessa do anúncio com a conversa comercial.',
      ],
    })
  }
  ...
  if (unhappyMarketing && mainProblem === 'Não sei') {
    return createDiagnostic({
      ...
      resumo: 'Existe investimento em marketing, mas ainda não há clareza sobre o ponto exato que impede o resultado. Quando o problema não está visível, qualquer nova ação vira tentativa: mais conteúdo, mais anúncio, mais ferramenta, mais cobrança do time.',
      gargalo: 'Ausência de leitura do funil. Sem saber onde as pessoas entram, onde param e por que não compram, a empresa toma decisões no escuro.',
      risco: 'O negócio pode continuar acumulando ações soltas, sem conseguir identificar o que realmente aumenta vendas e o que apenas consome tempo e dinheiro.',
      ...
      checklist: [
        'Mapear cada etapa entre atração, atendimento e venda.',
        'Registrar origem dos contatos e status de cada oportunidade.',
        'Definir uma métrica principal para acompanhar semanalmente.',
      ],
    })
  }
  ...
  if (fromPhysical && (noMarketing || failedMarketing)) {
    return createDiagnostic({
      ...
      resumo: `Hoje suas vendas dependem muito do movimento físico: quem passa, quem já conhece ou quem recebe indicação. Isso funciona, mas tem limite. ${failedMarketing ? 'Se você já tentou o digital e não teve resultado, o problema pode estar na estratégia, não necessariamente no canal.' : 'Sem uma presença digital estruturada, sua empresa fica menos visível para quem ainda não conhece a marca.'}`,
      gargalo: 'A loja tem operação, produto ou serviço, mas ainda não possui uma estrutura digital simples para gerar fluxo novo e previsível.',
      risco: 'O crescimento fica dependente de localização, sazonalidade e relacionamento atual. Quando o movimento cai, a empresa sente rápido.',
      ...
      checklist: [
        'Organizar presença no Google, Instagram e WhatsApp.',
        'Criar ofertas fáceis de entender para atrair novos contatos.',
        'Medir quais canais trazem pessoas para atendimento ou visita.',
      ],
    })
  }
  ...
  if (fromWhatsapp && (noMarketing || failedMarketing) && noProcess) {
    return createDiagnostic({
      ...
      resumo: 'Vendas por WhatsApp e indicação são valiosas, porque mostram que existe confiança no que você entrega. O ponto é que esse modelo depende muito de quem já conhece você ou de alguém que indique no momento certo.',
      gargalo: 'A aquisição ainda não é previsível. Sem marketing estruturado e sem processo comercial, a empresa fica esperando a demanda aparecer em vez de criar demanda de forma consistente.',
      risco: 'O crescimento pode ficar travado no mesmo círculo de contatos, com meses bons e ruins dependendo do volume de indicações.',
      ...
      checklist: [
        'Transformar dúvidas frequentes do WhatsApp em conteúdo e oferta.',
        'Criar uma rotina de captação para novos contatos.',
        'Registrar oportunidades para não perder conversas em aberto.',
      ],
    })
  }
  ...
  if (currentGoal === 'Treinar meu time de vendas' && hasTeam && noProcess) {
    return createDiagnostic({
      ...
      resumo: `Você tem ${salesTeam} vendedores ou atendentes, mas sem um processo definido cada pessoa tende a vender de um jeito. Isso gera diferença de abordagem, perda de padrão e dificuldade para saber o que realmente funciona.`,
      gargalo: 'O time precisa de processo antes de treinamento. Treinar sem definir etapas, scripts, critérios e rotina costuma gerar motivação temporária, mas pouca previsibilidade.',
      risco: 'A empresa pode cobrar mais resultado do time sem entregar o método necessário para repetir vendas com consistência.',
      proximoPasso: 'Primeiro o processo, depois o treinamento. Definir como vender antes de treinar o time a vender mais.',
      checklist: [
        'Definir etapas comerciais que todo vendedor deve seguir.',
        'Criar padrão mínimo de abordagem, follow-up e proposta.',
        'Acompanhar desempenho por etapa, não apenas venda final.',
      ],
    })
  }
  ...
  if (salesProcess === 'Sim' && hasTeam && (investsMarketing || unhappyMarketing)) {
    return createDiagnostic({
      ...
      resumo: 'Você já tem os três pilares que mais importam para crescer com consistência: aquisição, time e processo. Isso indica que a empresa saiu da fase totalmente improvisada e pode começar a olhar para escala com mais método.',
      gargalo: 'O próximo limite provavelmente não é começar do zero, mas melhorar controle, gestão, metas, indicadores e velocidade de execução.',
      risco: 'Sem gestão mais precisa, a empresa pode crescer aumentando complexidade, custo e dependência de pessoas específicas.',
      proximoPasso: 'Definir metas, métricas e um sistema de gestão comercial que sustente o crescimento sem depender só de você.',
      checklist: [
        'Definir metas por canal, etapa e responsável.',
        'Medir custo, conversão e receita gerada por origem.',
        'Padronizar rotina comercial para crescer sem perder controle.',
      ],
    })
  }
  ...
  if (noProcess && !hasTeam && (noMarketing || failedMarketing) && mainProblem === 'Não sei') {
    return createDiagnostic({
      ...
      resumo: 'Seu negócio ainda parece funcionar de forma bastante manual. Isso não é necessariamente ruim: nessa fase, pequenas melhorias em oferta, atendimento e presença digital podem gerar avanço rápido.',
      gargalo: 'A base ainda não está organizada. Antes de pensar em campanhas complexas, o negócio precisa deixar claro o que vende, para quem vende e como conduz cada interessado.',
      risco: 'Se a base não for construída, qualquer ação de marketing pode gerar pouco resultado porque não existe caminho claro entre interesse e compra.',
      ...
      checklist: [
        'Definir uma oferta principal e fácil de entender.',
        'Criar um processo simples para responder e acompanhar interessados.',
        'Escolher um canal inicial de aquisição antes de tentar vários ao mesmo tempo.',
      ],
    })
  }
  ...
  return createDiagnostic({
    ...
    resumo: `Com ${fromInstagram ? 'presença no Instagram' : fromWhatsapp ? 'vendas por indicação e WhatsApp' : fromPhysical ? 'loja física' : 'presença online'} e ${noMarketing ? 'marketing ainda informal' : 'algum movimento de marketing'}, sua empresa já tem base para evoluir. O ponto central agora é transformar ações soltas em um sistema mais claro de aquisição, atendimento e venda.`,
    gargalo: 'A estrutura comercial ainda parece pouco organizada para gerar crescimento previsível. Existe oportunidade, mas falta método para repetir o resultado.',
    risco: 'Sem estrutura, a empresa pode depender demais de esforço pontual, indicação, sorte ou campanhas isoladas.',
    ...
    checklist: [
      'Mapear de onde vêm os melhores contatos hoje.',
      'Definir uma rotina simples para atendimento e follow-up.',
      'Organizar uma oferta principal antes de ampliar canais.',
    ],
  })
}
        ...
        <>
          ...
          <section className="pricing-section" aria-labelledby="pricing-title">
            ...
            <p className="pricing-sub">
              Para receber um diagnóstico completo, o valor é R$ 5.000, mas
            ...
            <div className="pricing-comparison">
              ...
              <div className="pricing-side pricing-side--current">
                <span className="pricing-side-label">Hoje, para você</span>
            ...
            <div className="pricing-cta">
              <button className="primary-action pricing-action" onClick={startApplication} type="button">
                <span className="primary-action-label">Ir para o diagnóstico</span>
              </button>
            </div>
              ...
              {[
                {
                  ...
                  a: (
                    <>
                      Todos recebem o diagnóstico. Algumas pessoas recebem o
                      diagnóstico logo após responder às perguntas,
                      enquanto outras serão chamadas para agendar uma call 100% gratuita.
                      Isso acontece porque algumas empresas podem não estar prontas ainda para
                ...
                },
                {
                  ...
                  a: (
                    <>
                      Para contratar os serviços de gestão de tráfego,
                      treinamento de vendas, social media e outros,{' '}
                      <a
                        className="faq-link"
                ...
                },
                {
                  ...
                  a: (
                    <>
                      Ainda não temos cursos disponíveis. Queremos ajudar o máximo de pessoas
          ...
          <footer className="lp-footer">
            <div className="lp-footer-bottom">
              <span className="lp-footer-copy">© 2026 Inácio Carlos · Todos os direitos reservados</span>
            </div>
          </footer>
        </>
      )}
      ...
      {screen === 'success' && diagnostic && (
        <section className="success-screen" aria-labelledby="success-title">
          <div className="diagnostic-result">
            ...
            <p className="diagnostic-analise">{diagnostic.resumo}</p>

            <div className="diagnostic-grid">
              <article className="diagnostic-card">
                <span className="diagnostic-card-label">Principal gargalo</span>
                <p>{diagnostic.gargalo}</p>
              </article>
              <article className="diagnostic-card">
                <span className="diagnostic-card-label">Risco</span>
                <p>{diagnostic.risco}</p>
              </article>
            </div>
            ...
            <div className="diagnostic-actions-list">
              <span className="diagnostic-next-label">O que observar agora</span>
              <ul>
