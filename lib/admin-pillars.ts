...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'tarefas', label: 'Tarefas', href: '/admin/tarefas', status: 'built', icon: CheckSquare },
      { id: 'boletos', label: 'Boletos', href: '/admin/boletos', status: 'built', icon: Receipt },
    ...
    shortcuts: [
      ...
      { label: 'Nova tarefa', href: '/admin/tarefas', status: 'built', icon: CheckSquare },
      ...
      { label: 'Novo boleto', href: '/admin/boletos', status: 'built', icon: Receipt },
